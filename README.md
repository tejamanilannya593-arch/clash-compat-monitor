...
一个面向 Clash Verge Rev 的轻量后台节点择优器。v0.1.0 以稳定性为第一目标，在不接管订阅的前提下，综合平台可用性、响应、抖动、吞吐和倍率选择统一节点。
...
无登录后台检测无法证明 ChatGPT 对话或 Gemini 生成等账号级功能一定可用，也无法消除网站自身故障、账号风控或代理供应商拥堵。v0.1.0 是本地优先的初版，不上传遥测数据。
