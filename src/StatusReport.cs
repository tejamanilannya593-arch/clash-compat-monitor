...
public static class StatusReport
{
    ...
    public static string DecisionText(string decision)
    {
        ...
        switch (decision)
        {
            ...
            case "target requires account verification": return "候选节点尚未完成所选 AI 服务的真实对话验证，不进行性能切换";
            case "target requires strict service evidence": return "候选节点仅确认基础可达，不进行自动切换";
            case "provisional emergency failover": return "当前节点故障，临时切换到网络链路已通过但尚未完成真实对话验证的节点";
