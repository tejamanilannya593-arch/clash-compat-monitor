...
- The local v0.6.3-preview.1 build adds an optional Z-Library web entrance check at the user-specified `https://zh.z-library.sk/`. It is off by default and measures only HTTP reachability and latency, not sign-in, search, or downloads. It does not discover alternate mirrors and is not a formal GitHub release.
