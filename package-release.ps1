...
$release = Join-Path $distRoot 'ClashCompatibilityMonitor-v0.6.3-preview.3'
...
Copy-Item -LiteralPath (Join-Path $root 'docs\release-notes\v0.6.3-preview.3.md') -Destination (Join-Path $release 'docs\release-notes')
