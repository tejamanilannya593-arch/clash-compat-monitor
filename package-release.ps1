...
$release = Join-Path $distRoot 'ClashCompatibilityMonitor-v0.7.0-preview.9'
...
Copy-Item -LiteralPath (Join-Path $root 'docs\release-notes\v0.7.0-preview.9.md') -Destination (Join-Path $release 'docs\release-notes')
$zip = $release + '.zip'
