...
$release = Join-Path $distRoot 'ClashCompatibilityMonitor-v0.7.0-preview.11'
...
Copy-Item -LiteralPath (Join-Path $root 'docs\release-notes\v0.7.0-preview.11.md') -Destination (Join-Path $release 'docs\release-notes')
$zip = $release + '.zip'
